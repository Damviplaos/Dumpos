...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-ca8n8duf25mp-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| Query Endpoint | `GET https://app-ca8n8duf25mp-api-pLVzAEz1ZQOL.gateway.appmedo.com/v1/videos/omni-video/{task_id}` |

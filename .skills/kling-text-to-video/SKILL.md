...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-ca8n8duf25mp-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| Query Endpoint | `GET https://app-ca8n8duf25mp-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |
